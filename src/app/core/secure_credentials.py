...
class SecureCredentialLoader:
    ...
    def get_api_credentials(self, fallback_user: str = "admin", fallback_pass: str = "dev_password") -> tuple[str, str]:
        """
        ...
        if password == fallback_pass:
            logger.warning("Using default fallback password - this should be changed in production!")
