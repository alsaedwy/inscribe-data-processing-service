...
class Settings(BaseSettings):
    ...
    api_credentials_secret_name: str = Field(
        default="dev-inscribe-application-secrets", 
        env="API_CREDENTIALS_SECRET_NAME"
    )
    ...
    datadog_service_name: str = Field(default="inscribe-customer-service", env="DATADOG_SERVICE_NAME")
    ...
    def get_api_credentials(self) -> tuple[str, str]:
        ...
        if self.use_secrets_manager:
            try:
                ...
                username, password = secrets_manager.get_api_credentials(self.api_credentials_secret_name)
